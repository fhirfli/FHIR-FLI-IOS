    ...
    */
    ...
    func checkToday(concept: String, date:String, callback: () -> ()) {
       ...
       Alamofire
        ...
        .request(.GET, "http://51.140.74.135:8080/openmrs/ws/fhir/Observation?date="+date+"T00:00:00", headers: headers)
    ...
    func checkYesterday(concept: String, date: String, value: Double, callback: () -> ()) {
        ...
        Alamofire
            //.request(.GET, "http://uclactiveserver.westeurope.cloudapp.azure.com:8080/openmrs/ws/fhir/Observation?date="+date+"T00:00:00", headers: headers)
            .request(.GET, "http://51.140.74.135:8080/openmrs/ws/fhir/Observation?given=kin&date="+date+"T00:00:00", headers: headers)
            .responseJSON { response in
                var json = JSON(response.result.value!)
                var i = 0
                self.ok = 0
    ...
    func deleteObs(uuid: String, callback: () -> ()) {
        ...
        let url: String = "http://51.140.74.135:8080/openmrs/ws/fhir/Observation/"+uuid;
        ...
        //callback()
        //Alamofire.request(.POST, "http://diananodejs.azurewebsites.net/deleteObs", parameters: parameters)
        //callback()
        Alamofire.request(.POST, "http://transpire.azurewebsites.net/deleteObs", parameters: parameters)
        callback()
...
//                "reference":"Patient/" + self.person_uuid
        ...
        print("I'm here! Num1");
        //Alamofire.request(.POST, "http://diananodejs.azurewebsites.net/sendmessage", parameters: parameters as! [String : AnyObject])
        Alamofire.request(.POST, "http://transpire.azurewebsites.net/sendmessage", parameters: parameters as! [String : AnyObject])
        //Alamofire.request(.POST, "http://200.72.201.128:3000/sendmessage", parameters: parameters as! [String : AnyObject])
        print("I'm here! Num2");
...
//                "reference":"Patient/" + self.person_uuid
        ...
        print("I'm here! Str1");
        //Alamofire.request(.POST, "http://diananodejs.azurewebsites.net/sendmessage", parameters: parameters)
        Alamofire.request(.POST, "http://transpire.azurewebsites.net/sendmessage", parameters: parameters)
        //Alamofire.request(.POST, "http://200.72.201.128:3000/sendmessage", parameters: parameters)
        print("I'm here! Str2");
    }
